...
public class RoutePlanActivity extends Activity implements
	...
	private UserBean stUserBean;// 从，就是我的用户信息
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		stUserBean = (UserBean) getIntent().getSerializableExtra("st");
		enUserBean = (UserBean) getIntent().getSerializableExtra("en");

		stLatLng = new LatLng(stUserBean.getLatitude(),
				stUserBean.getLongitude());
		enLatLng = new LatLng(enUserBean.getLatitude(),
				enUserBean.getLongitude());
